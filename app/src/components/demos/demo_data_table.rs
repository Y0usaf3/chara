        ...
        <div class="py-8 w-full">
            ...
            <DataTableWrapper>
                <DataTable>
                        ...
                        <DataTableRow>
                                ...
                                <Checkbox
                                    ...
                                    checked=Signal::derive(move || {
                                        sorted_payments_signal
                                            .with(|payments| {
                                                !payments.is_empty()
                                                    && selected_count_signal.get() == payments.len()
                                            })
                                    })
                            ...
                            {move || {
                                columns_signal
                                    ...
                                    .then(|| {
                                        view! {
                                            <DataTableHead class="px-4 text-right">
                                                Amount
                                            </DataTableHead>
                                        }
                                    })
                    ...
                    <DataTableBody>
                        <For
                            each=move || sorted_payments_signal.get()
                        ...
                        >
                            {
                                let is_selected = Signal::derive(move || {
                                    selected_emails_signal
                                        .with(|selected| selected.contains(payment.email))
                                });
                                view! {
